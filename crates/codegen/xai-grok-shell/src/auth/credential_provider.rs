...
/// Construct the inert storage compatibility handle used by legacy restore
/// call sites. The returned privacy-build client contains no HTTP transport;
/// every read/write operation fails closed.
...
pub fn build_storage_client_for_proxy(
    ...
    xai_file_utils::storage_client::StorageClient::new("privacy://storage-disabled", "")
}
