...
`--force-with-lease` bound to the previously fetched `origin/main` SHA. Current
and future release tags are treated as immutable after publication. Source
auditing, offline release builds, runtime rejection tests, native archive
creation, checksums, and GitHub Release publication share one cross-platform
